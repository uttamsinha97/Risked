...
void record ::addrecord()
{
                ...
                while ( another == 'Y'|| another=='y' )
                {
                    ...
                    rewind(fp);
                   // rewind(outfile);
                   //while(outfile.addrecord(&e,sizeof(e),1,fp)==1))
...
{
    FILE *fpte ;
    record customer ; // customer is an object of class record
...
{
        FILE *fpte ;
        record customer ; //customer is the object
        char time[6],choice,filename[14];
        int num,count=0;
        cout<<"\n\n\t\t*******************************\n";
...
int main()
{
   // SetConsoleTextAttribute(GetStdHandle(STD_OUTPUT_HANDLE),0xFC);
    record a; // record is class . creating object of class . a is an object
    int password();
    void addrecord();
    void viewrecord();
    void editrecord();
    ...
    while(1)
    {
        ...
        switch(ch)
        {
            ...
            case 3:a.editrecord();
                   break;
            case 4:a.deleterecord();
                   break;
            case 5:a.editpassword();
                   break;
